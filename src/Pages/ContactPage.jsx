...
const ContactPage = () => {
  return (
    <div>
      <div
        className="justify-content-between d-lg-flex text-white"
        style={{ width: "100%" }}
      >
        <div className="container general-contact-2 mb-5">
          <div className="ContactPage">
            ...
            <div className="d-flex align-items-center gap-lg-5 justify-content-between justify-content-lg-start">
              <img
                src={profile}
                alt=""
                className="w-25 img-fluid rounded-5"
        ...
        <div className="general-contact-3">
          <ContactInput />
        </div>
      </div>
    </div>
